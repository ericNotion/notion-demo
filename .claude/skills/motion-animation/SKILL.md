...
description: Guidelines for animating with the Motion animation library. Use when writing animations, using motion values, or optimizing animation performance in React/JavaScript. Covers animate API, motion values, and performance best practices.
---
