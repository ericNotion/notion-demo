---
name: motion-react
description: Guidelines for animating with Motion for React (formerly Framer Motion). Use when writing React animations in TSX/JSX, using motion components, useTransform, useSpring, or integrating with Radix UI. Covers imports, performance, motion values, and Radix integration.
---
