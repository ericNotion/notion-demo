...
import { dragHandleSmallIcon } from "@nds-icons/dragHandle/small.icon";
...
function ResizableHandle({
  ...
  return (
    ...
    >
      {withHandle && (
        <div className="bg-tertiary z-10 flex h-4 w-3 items-center justify-center rounded-xs border">
          <Icon
            icon={dragHandleSmallIcon}
            size={10}
