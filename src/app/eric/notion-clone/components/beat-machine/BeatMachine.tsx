...
const subtitleStyle = { color: "rgba(255,255,255,0.35)" };
const nowPlayingStyle = { color: "rgba(255,255,255,0.3)" };

const sequencerBoxStyle = {
    ...
    <div className="min-h-screen w-full" style={containerStyle}>
      <div className="mx-auto max-w-4xl px-6 py-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 font-mono text-sm" style={subtitleStyle}>
        ...
        {/* Step Sequencer */}
        <div className="mb-8 rounded-xl p-5" style={sequencerBoxStyle}>
          <StepSequencer />
        </div>
