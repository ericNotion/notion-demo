...
export const iconDefinition: IconDefinition = {
  ...
  svg: (
    <>
      <g clipPath="url(#clip0_9429_10329)">
...
export const calendarBadgeClockFillSmallIcon: LoadedIconFunction = createIcon(
  "calendarBadgeClockFillSmall",
  iconDefinition,
);
