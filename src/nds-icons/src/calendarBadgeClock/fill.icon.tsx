...
export const iconDefinition: IconDefinition = {
  ...
  svg: (
    <>
      <g clipPath="url(#clip0_9429_10327)">
...
export const calendarBadgeClockFillIcon: LoadedIconFunction = createIcon(
  "calendarBadgeClockFill",
  iconDefinition,
);
