...
export const iconDefinition: IconDefinition = {
  ...
  svg: (
    <>
      <g clipPath="url(#clip0_9429_11607)">
...
export const calendarBadgeXFillSmallIcon: LoadedIconFunction = createIcon(
  "calendarBadgeXFillSmall",
  iconDefinition,
);
