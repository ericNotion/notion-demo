...
export const iconDefinition: IconDefinition = {
  ...
  svg: (
    <>
      <g clipPath="url(#clip0_9035_11357)">
...
export const circleDottedAndCircleFillIcon: LoadedIconFunction = createIcon(
  "circleDottedAndCircleFill",
  iconDefinition,
);
